const CustomDocumentType = require("./customDocumentTypeModel");
const AppCenter = require("../appCenter/appCenterModel");
const AppNavigationCenter = require("../appNavigationCenter/appNavigationCenterModel");
...
const convertToLowerCaseWithUnderscores = (text) => {
    // Convert to lowercase and replace spaces with underscores
    console.log(text);
    const result = text.toLowerCase().replace(/\s/g, '_');
    return result;
}
...
exports.deleteOne = catchAsync(async (req, res, next) => {
    ...
    console.log("App Navigation Center is deleted");

    // Deleting App Center
    await AppCenter.deleteOne({ name: document.documentTypeName })
    console.log("App Center is deleted");
    ...
    console.log("Delete Cust Record Type");
...
exports.createOne = catchAsync(async (req, res, next) => {
    ...
    const navCenterDoc = await AppNavigationCenter.create({
        navigationCenterId: 'nav_' + convertToLowerCaseWithUnderscores(req.body.documentTypeName),
        name: req.body.documentTypeName,
    })

    req.body.documentTypeId = 'doctype_' + convertToLowerCaseWithUnderscores(req.body.documentTypeName)
    ...
    const appCenterDoc = await AppCenter.create({
        ...
        navCenterLink: navCenterDoc._id,
